...
public class Time2 {
    ...
    public void tick() {
        totalSeconds = (totalSeconds + 1) % 86400; // Increment by 1 second, wrap around at 24 hours
    }

    public void incrementMinute() {
        totalSeconds = (totalSeconds + 60) % 86400; // Increment by 1 minute, wrap around at 24 hours
    }

    public void incrementHour() {
        totalSeconds = (totalSeconds + 3600) % 86400; // Increment by 1 hour, wrap around at 24 hours
    }
